...
sklearn2pmml(grid_estimator.best_estimator_, 'claim-model-decisionTree.pmml', with_repr = True)
...
objects_to_dump = { 
        'lencoder': lencoder,
        'cont-features': num_features_list,
        'cat-features':cat_features_list,
        'estimator':grid_estimator.best_estimator_
        }
joblib.dump(objects_to_dump, os.path.join("C:/Users/mpandavu/Desktop/Build-a-thon/Modelcreation", 'deployment.pkl') )
...
"NON_ELIG_BLNG_AMT,NON_ELIG_BLNG_AMT1,NON_ELIG_BLNG_AMT2,NON_ELIG_BLNG_AMT3,NON_ELIG_DESC_CD,NON_ELIG_DESC_CD1,NON_ELIG_DESC_CD2,NON_ELIG_DESC_CD3,NON_ELIG_ANSI_CD,"+
"NON_PYBL_AMT,SERV_PMT_AMT,SERV_PMT_AMT2,CHK_NBR,PAYEE_PMT_CD,SORT_SEQ,CHK_NBR_INT "+
" from aos.AOS0001T aos1t,aos.AOS0002T aos2t where aos1t.MCRFM_ROLL_CD=aos2t.MCRFM_ROLL_CD and aos1t.CLM_STTS_CD  in ('I') and aos1t.CREATE_DT>'20200101'",cnxn)
