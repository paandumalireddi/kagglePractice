...
from sklearn import impute,preprocessing,pipeline,decomposition,compose,feature_selection,ensemble,model_selection
...
print(metrics.confusion_matrix(y_test['CLM_STTS_CD'], y_test['predicted']))
print('\n[Precision]')
p = metrics.precision_score(y_test['CLM_STTS_CD'], y_test['predicted'])
print(p)
print('\n[Recall]')
r = metrics.recall_score(y_test['CLM_STTS_CD'], y_test['predicted'])
print(r)
print('\n[F1-score]')
f = metrics.f1_score(y_test['CLM_STTS_CD'], y_test['predicted'])
print(f)
